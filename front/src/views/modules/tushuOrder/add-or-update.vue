    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="订单快递单号" prop="tushuOrderCourierNumber">
                       <el-input v-model="ruleForm.tushuOrderCourierNumber"
                                 placeholder="订单快递单号" clearable  :readonly="ro.tushuOrderCourierNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="订单快递单号" prop="tushuOrderCourierNumber">
                           <el-input v-model="ruleForm.tushuOrderCourierNumber"
